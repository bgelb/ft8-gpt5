...
def test_full_dataset_nonregression():
    ...
    # Ratchet: require at least 64 exact-text, CRC-valid decodes overall (baseline ~65)
    assert total_pos_matched >= 64, "expected at least 64 matched decodes in full dataset"
