...
def test_short_dataset_regression_20pct():
	...
	# Ratchet for CI: increased threshold reflects improved frontend
	assert total_pos_matched >= 30, "expected at least thirty matched decodes in 20% short regression"
